...
function App() {
  ...
  const routeUpdate = ElementRoot.getAttribute("data-route-update");
  const routeIndex = ElementRoot.getAttribute("data-route-index");
  const csrfToken = ElementRoot.getAttribute("data-csrf");
  const [Municipalities, setMunicipalities] = useState([]);

  const initMunicipalities = () => {
    const initialMunicipalities = municipalities.filter(
      (item) => item.state_id == delivery_man.user.address.state.id
    );
          ...
          <div className="grid gap-4 mb-4 lg:grid-cols-2">
            <div>
              ...
              <input
                ...
                defaultValue={delivery_man.user.email}
                {...register("email", {
                  required: {
                    value: true,
            ...
            <div>
              ...
              <input
                ...
                defaultValue={delivery_man.user.username}
                {...register("username", {
                  required: {
                    value: true,
          ...
          <div className="grid gap-4 mb-4 lg:grid-cols-2">
            <div>
              ...
              <input
                ...
                defaultValue={delivery_man.user.name}
                {...register("name", {
                  required: {
                    value: true,
            ...
            <div>
              ...
              <input
                ...
                id="birth"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:outline-none"
                defaultValue={delivery_man.user.birth}
                {...register("birth", {
                  required: {
                    value: true,
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                <select
                  ...
                  defaultValue={delivery_man.user.identification_card.type}
                >
                ...
                <div className="relative z-0 w-full">
                  <input
                    ...
                    defaultValue={
                      delivery_man.user.identification_card
                    ...
                    {...register("identification_number", {
                      ...
                      maxLength: {
                        value: 9,
                        message:
                          "El número de cédula no debe tener más de 9 caracteres!",
                      },
                      pattern: {
                        value: /^[0-9]+$/,
                        message:
            ...
            <div className="flex gap-2 flex-col">
              ...
              <div className="flex gap-2">
                <select
                  ...
                  defaultValue={delivery_man.user.phone.code_phone}
                  required
                >
                  {phoneCodes.map((item) => (
                    <option key={item} value={item}>
                ...
                <div className="relative z-0 w-full">
                  <input
                    ...
                    defaultValue={delivery_man.user.phone.phone_number}
            ...
            <div className="relative z-0 w-full">
              ...
              <select
                ...
                onChange={filterData}
                defaultValue={delivery_man.user.address.state.id}
                required
              >
            ...
            <div className="relative z-0 w-full">
              ...
              <select
                ...
                id="municipality_id"
                className="w-full px-2 focus:bg-violet-50 border focus:border-violet-600 text-gray-900 text-sm rounded-lg block py-2.5 dark:bg-gray-700 dark:focus:border-violet-600 dark:text-white focus:outline-none"
                defaultValue={delivery_man.user.address.municipality.id}
                required
              >
                <option value="">--Seleccionar--</option>
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                defaultValue={delivery_man.user.address.address}
                {...register("address", {
                  required: {
                    value: true,
          ...
          <div className="grid gap-4 mb-4 lg:grid-cols-2">
            <div>
              ...
              <select
                ...
                defaultValue={delivery_man.vehicle_type}
                required
            ...
            <div>
              ...
              <input
                ...
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:outline-none"
                placeholder="ASDF456"
                defaultValue={delivery_man.plate}
                {...register("plate", {
                  required: {
                    value: true,
