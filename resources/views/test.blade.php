              ...
              <li class="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                <article aria-labelledby="question-title-81614">
                  <div>
                        ...
                        <div x-data="Components.menu({ open: false })" x-init="init()"
                          ...
                          <div>
                            <button type="button"
                              ...
                              id="options-menu-0-button" x-ref="button" @click="onButtonClick()"
                          ...
                          <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div class="py-1" role="none">
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm" x-state:on="Active"
                                x-state:off="Not Active"
                                :class="{
                                    'bg-gray-100 text-gray-900': activeIndex === 0,
                                    'text-gray-700': !(activeIndex ===
                                        0)
                                }"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                <svg class="mr-3 h-5 w-5 text-gray-400"
                                  x-description="Heroicon name: mini/code-bracket" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <h2 id="question-title-81614" class="mt-4 text-base font-medium text-gray-900">You should use
                      alpinejs framework</h2>
                  </div>
                  <div class="mt-2 space-y-4 text-sm text-gray-700">
                    <p>Arradawark touches Spark was an incredible idea and a magnificent feat of engineering, but poor
                      protocols and a disregard for human safety killed what could have otherwise been one of the best
                      businesses of our generation.</p>
                    <p>Ultimately, I think that if you wanted to run the park successfully and keep visitors safe, the
                      most important thing to prioritize would be…</p>
                  </div>
              ...
              <li class="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                <article aria-labelledby="question-title-89019">
                  <div>
                      ...
                      <div class="flex flex-shrink-0 self-center">
                        <div x-data="Components.menu({ open: false })" x-init="init()"
                          ...
                          <div>
                            <button type="button"
                              class="-m-2 flex items-center rounded-full p-2 text-gray-400 hover:text-gray-600"
                              id="options-menu-1-button" x-ref="button" @click="onButtonClick()"
                              @keyup.space.prevent="onButtonEnter()" @keydown.enter.prevent="onButtonEnter()"
                              aria-expanded="false" aria-haspopup="true" x-bind:aria-expanded="open.toString()"
                              @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()">
                              <span class="sr-only">Open options</span>
                          ...
                          <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div class="py-1" role="none">
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm" x-state:on="Active"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-1-item-0"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 0)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/star"
                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-1-item-1"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 1)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400"
                                  x-description="Heroicon name: mini/code-bracket" xmlns="http://www.w3.org/2000/svg"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-1-item-2"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 2)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/flag"
                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    ...
                    <h2 id="question-title-89019" class="mt-4 text-base font-medium text-gray-900">What's it like to
                      be a golden retriever?</h2>
                  </div>
                  <div class="mt-2 space-y-4 text-sm text-gray-700">
                    <p>Man I am glad you asked this question. I'm a 6 year old golden retriever and while I still have
                      a few years left to experience, I think I've been around long enough to tell you what it's
                      really like.</p>
                    <p>Most people think being a dog is awesome. You sleep as much as you want, all of your meals are
                      prepared for you, and someone literally picks up your poop you. And yeah, you know what, those
                      parts <em>are</em> pretty awesome. But there's a dark side to being a golden retriever that they
                      don't tell you about…</p>
                  </div>
                  <div class="mt-6 flex justify-between space-x-8">
                    <div class="flex space-x-6">
                      <span class="inline-flex items-center text-sm">
              ...
              <li class="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                <article aria-labelledby="question-title-92742">
                  <div>
                      ...
                      <div class="flex flex-shrink-0 self-center">
                        <div x-data="Components.menu({ open: false })" x-init="init()"
                          ...
                          <div>
                            <button type="button"
                              class="-m-2 flex items-center rounded-full p-2 text-gray-400 hover:text-gray-600"
                              id="options-menu-2-button" x-ref="button" @click="onButtonClick()"
                              @keyup.space.prevent="onButtonEnter()" @keydown.enter.prevent="onButtonEnter()"
                              aria-expanded="false" aria-haspopup="true" x-bind:aria-expanded="open.toString()"
                              @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()">
                              <span class="sr-only">Open options</span>
                          ...
                          <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            aria-orientation="vertical" aria-labelledby="options-menu-2-button" tabindex="-1"
                            @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()"
                            @keydown.tab="open = false" @keydown.enter.prevent="open = false; focusButton()"
                            @keyup.space.prevent="open = false; focusButton()">
                            <div class="py-1" role="none">
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm" x-state:on="Active"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-2-item-0"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 0)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/star"
                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-2-item-1"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 1)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400"
                                  x-description="Heroicon name: mini/code-bracket" xmlns="http://www.w3.org/2000/svg"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-2-item-2"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 2)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/flag"
                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    ...
                    <h2 id="question-title-92742" class="mt-4 text-base font-medium text-gray-900">Am I actually
                      dead like the guy from the Sixth Sense?</h2>
                  </div>
                  <div class="mt-2 space-y-4 text-sm text-gray-700">
                    <p>This is something most people wonder about themselves at least 4 or 5 times throughout their
                      life. Everyone ignores you for weeks on end (including your immediate family) and the only
                      person who will talk to you is a little boy you are treating because he thinks he sees dead
                      people.</p>
                    <p>The fact is, you can't <em>really</em> know if you're just a weird dead ghost thing until the
                      rest of the world finally decides to acknowledge you again. But there are a few things you can
                      test that are generally <em>correlated</em> with not being a weird dead ghost thing, namely…</p>
                  </div>
                  <div class="mt-6 flex justify-between space-x-8">
                    <div class="flex space-x-6">
                      <span class="inline-flex items-center text-sm">
              ...
              <li class="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                <article aria-labelledby="question-title-41150">
                  <div>
                      ...
                      <div class="flex flex-shrink-0 self-center">
                        <div x-data="Components.menu({ open: false })" x-init="init()"
                          ...
                          <div>
                            <button type="button"
                              class="-m-2 flex items-center rounded-full p-2 text-gray-400 hover:text-gray-600"
                              id="options-menu-3-button" x-ref="button" @click="onButtonClick()"
                              @keyup.space.prevent="onButtonEnter()" @keydown.enter.prevent="onButtonEnter()"
                              aria-expanded="false" aria-haspopup="true" x-bind:aria-expanded="open.toString()"
                              @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()">
                              <span class="sr-only">Open options</span>
                          ...
                          <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            x-ref="menu-items" x-description="Dropdown menu, show/hide based on menu state."
                            x-bind:aria-activedescendant="activeDescendant" role="menu"
                            aria-orientation="vertical" aria-labelledby="options-menu-3-button" tabindex="-1"
                            @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()"
                            @keydown.tab="open = false" @keydown.enter.prevent="open = false; focusButton()"
                            @keyup.space.prevent="open = false; focusButton()">
                            <div class="py-1" role="none">
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm" x-state:on="Active"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-3-item-0"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 0)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/star"
                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-3-item-1"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 1)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400"
                                  x-description="Heroicon name: mini/code-bracket" xmlns="http://www.w3.org/2000/svg"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-3-item-2"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 2)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/flag"
                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    ...
                    <h2 id="question-title-41150" class="mt-4 text-base font-medium text-gray-900">What's the most
                      unforgettable meal you've ever had?</h2>
                  </div>
                  <div class="mt-2 space-y-4 text-sm text-gray-700">
                    <p>One time we ordered a pizza from this local place downtown we'd always wanted to try. Everyone
                      told us it was the best pizza they'd ever had in their entire lives and we couldn't wait to see
                      what it was all about.</p>
                    <p>We placed the order at 5:45pm and it showed up at around 6:30pm. We opened the box excited to
                      take in the aroma of this incredible pie, but we were not prepared for what we saw. Instead of
                      the pepperoni pizza we ordered, they had delivered us a…</p>
                  </div>
                  <div class="mt-6 flex justify-between space-x-8">
                    <div class="flex space-x-6">
                      <span class="inline-flex items-center text-sm">
              ...
              <li class="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                <article aria-labelledby="question-title-62760">
                  <div>
                      ...
                      <div class="flex flex-shrink-0 self-center">
                        <div x-data="Components.menu({ open: false })" x-init="init()"
                          ...
                          <div>
                            <button type="button"
                              class="-m-2 flex items-center rounded-full p-2 text-gray-400 hover:text-gray-600"
                              id="options-menu-4-button" x-ref="button" @click="onButtonClick()"
                              @keyup.space.prevent="onButtonEnter()" @keydown.enter.prevent="onButtonEnter()"
                              aria-expanded="false" aria-haspopup="true" x-bind:aria-expanded="open.toString()"
                              @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()">
                              <span class="sr-only">Open options</span>
                          ...
                          <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            x-ref="menu-items" x-description="Dropdown menu, show/hide based on menu state."
                            x-bind:aria-activedescendant="activeDescendant" role="menu"
                            aria-orientation="vertical" aria-labelledby="options-menu-4-button" tabindex="-1"
                            @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()"
                            @keydown.tab="open = false" @keydown.enter.prevent="open = false; focusButton()"
                            @keyup.space.prevent="open = false; focusButton()">
                            <div class="py-1" role="none">
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm" x-state:on="Active"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-4-item-0"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 0)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/star"
                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-4-item-1"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 1)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400"
                                  x-description="Heroicon name: mini/code-bracket" xmlns="http://www.w3.org/2000/svg"
                              ...
                              <a href="#" class="text-gray-700 flex px-4 py-2 text-sm"
                                ...
                                role="menuitem" tabindex="-1" id="options-menu-4-item-2"
                                @mouseenter="onMouseEnter($event)" @mousemove="onMouseMove($event, 2)"
                                @mouseleave="onMouseLeave($event)" @click="open = false; focusButton()">
                                <svg class="mr-3 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/flag"
                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    ...
                    <h2 id="question-title-62760" class="mt-4 text-base font-medium text-gray-900">What would your
                      pro wrestling finishing move be?</h2>
                  </div>
                  <div class="mt-2 space-y-4 text-sm text-gray-700">
                    <p>Great question. The first thing you need to decide is should your finishing move be something
                      you do to hurt your opponent enough to then get the pin, or a submission move that causes your
                      opponent to give up.</p>
                    <p>Personally, I've always found submission moves to be a lot less exciting than a powerbomb or a
                      moonsault off the top rope. Sure there's a few classics that the crowd goes nuts for like the
                      Sharpshooter, but most of them just don't get the same pop as a Tombstone or a Stone Cold
                      Stunner. If I had to choose, my first choice would be…</p>
                  </div>
                  <div class="mt-6 flex justify-between space-x-8">
                    <div class="flex space-x-6">
                      <span class="inline-flex items-center text-sm">
              ...
              <li class="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                <article aria-labelledby="question-title-41387">
                  <div>
                      ...
                      <div class="flex flex-shrink-0 self-center">
                        <div x-data="Components.menu({ open: false })" x-init="init()"
                          ...
                          <div>
                            <button type="button"
                              class="-m-2 flex items-center rounded-full p-2 text-gray-400 hover:text-gray-600"
                              id="options-menu-5-button" x-ref="button" @click="onButtonClick()"
                              @keyup.space.prevent="onButtonEnter()" @keydown.enter.prevent="onButtonEnter()"
                              aria-expanded="false" aria-haspopup="true" x-bind:aria-expanded="open.toString()"
                              @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()">
                              <span class="sr-only">Open options</span>
                          ...
                          <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            x-ref="menu-items" x-description="Dropdown menu, show/hide based on menu state."
                            x-bind:aria-activedescendant="activeDescendant" role="menu"
                            aria-orientation="vertical" aria-labelledby="options-menu-5-button" tabindex="-1"
                            @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()"
                            @keydown.tab="open = false" @keydown.enter.prevent="open = false; focusButton()"
                            @keyup.space.prevent="open = false; focusButton()">
                            <div class="py-1" role="none">
                    ...
                    <h2 id="question-title-41387" class="mt-4 text-base font-medium text-gray-900">How on earth do
                      magnets work though seriously?</h2>
                  </div>
                  <div class="mt-2 space-y-4 text-sm text-gray-700">
                    <p>Magnets are an incredibly interesting natural phenomenon, with their discovery dating back at
                      least 2500 years.</p>
                    <p>Scientists will tell you a bunch of stuff about how in magnetic materials, most of the
                      electrons spin in the same direction. Somehow that apparently magically makes random bits of
                      metal stick together. Sure, okay scientists. Here's the truth, what they don't want you to know…
                    </p>
                  </div>
                  <div class="mt-6 flex justify-between space-x-8">
                    <div class="flex space-x-6">
