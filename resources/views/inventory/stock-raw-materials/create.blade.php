<x-layout title="Inventario Materias Primas - Registrar Entrada" :vite="['js/flowbite.min.js']" react notifications>

  <x-main.admin>
    <x-title title="Inventario Materias Primas - Registrar Entradas" />

    <div class="w-full" x-data="stockRawMaterial">
      <div class="px-3 py-6 md:px-10 lg:x-20">
        <div
          ...
          <div>
            ...
            <div class="w-96">
              <form class="flex items-center">
                ...
                <div class="relative w-full">
                  ...
                  <input type="text" @keyup="search" x-model="inputSearch" placeholder="Buscar Materia"
            ...
            <template x-if="rawMaterials != null">
          ...
          <form @submit="addRawMaterialToCart">
            <x-table.title title="Datos de la materia a añadir" />
            <div class="flex gap-6 flex-col xl:flex-row">
              <input type="hidden" name="raw_material_id" :value="rawMaterial.raw_material_id">
              <div class="relative z-0 w-full">
                <input type="text" id="name" name="name"
                  ...
                  placeholder=" " :value="rawMaterial.name" readonly>
                <label for="name"
              ...
              <div class="relative z-0 w-full">
                <input type="number" id="quantity"
                  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-600 focus:outline-none focus:ring-0 focus:border-violet-600 peer"
                  placeholder=" " name="quantity" :value="rawMaterial.quantity">
                <label for="quantity"
                  class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-violet-600 peer-focus:dark:text-violet-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                  Cantidad *
                </label>
              ...
              <div class="relative z-0 w-full">
                <input type="date" id="expires_at"
                  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-600 focus:outline-none focus:ring-0 focus:border-violet-600 peer"
                  placeholder=" " name="expires_at" :value="rawMaterial.expires_at">
        ...
        <div
                ...
                <div class="overflow-hidden shadow sm:rounded-lg">
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                    ...
                    <tbody class="bg-white dark:bg-gray-800">
                      <template x-for="rawMaterial in rawMaterialsInCart" :key="rawMaterial.raw_material_id">
                        <tr>
                          <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white"
                            x-text="rawMaterial.raw_material_id"></td>
                          <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400"
                            x-text="rawMaterial.name"></td>
                          <td class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap dark:text-white"
                            x-text="rawMaterial.quantity"></td>
                          <td class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap dark:text-white"
                            x-text="rawMaterial.expires_at"></td>
                          <td class="p-4 whitespace-nowrap">
                            <x-button color="danger" @click="removeRawMaterialFromCart(rawMaterial)">
                              <x-icons.trash />
                              Eliminar
                            </x-button>
                          </td>
          ...
          <div class="mt-6 flex justify-end gap-3">
            <div class="flex items-center lg:mx-4">
              <template x-if="rawMaterialsInCart.length != 0">
