  ...
  <div class="bg-white rounded-lg shadow-lg px-8 py-10 max-w-xl mx-auto">
    <div class="flex items-center justify-between mb-8">
      <div class="flex items-center">
        <img class="h-8 w-8 mr-2" src="../../public/images/logos/favicon-32x32.png" alt="Logo">
    ...
    <div class="border-t-2 border-gray-300 pt-8 mb-8">
      <div class="text-gray-700 mb-2">Payment is due within 30 days. Late payments are _______ to fees. </div>
      <div class="text-gray-700 mb-2">Please make checks payable __ Your Company Name and ____ to: </div>
      <div class="text-gray-700">123 Main St., Anytown, ___ 12345 </div>
    </div>
  </div>
