<x-layout title="Pedidos - Descripción de pedido" :vite="['js/flowbite.min.js']" react notifications>
      ...
      <section
        ...
        <div class="w-full">
          <h2 class="text-2xl font-bold dark:text-gray-100">Pedido N°
            {{ $invoice_order->id }}</h2>
          <h2 class="text-2xl font-bold dark:text-gray-100">Código de Pedido
            {{ $invoice_order->code }}</h2>
        </div>
