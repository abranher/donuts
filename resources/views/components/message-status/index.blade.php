@if (session('status'))
  <div id="alert-1"
    class="fixed top-20 left-0 z-40 flex items-center p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 w-full dark:border-t border-gray-600"
    role="alert">
